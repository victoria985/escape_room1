...
level_one = sg.Window('Escape: PIRMAS LYGIS', Layouts.layout_one(), font='Courier 20')

level_two = sg.Window('Escape: ANTRAS LYGIS', Layouts.layout_two(), font='Courier 20')

level_three = sg.Window('Escape: III LYGIS', Layouts.layout_three(), font='Courier 20')

level_four = sg.Window('Escape: KETVIRTAS LYGIS - NEMATOMAS RAŠALAS', Layouts.layout_four(), font='Courier 20')

level_five = sg.Window('Escape: 5 lygis', Layouts.layout_five(), font ='Courier 20', right_click_menu=sg.MENU_RIGHT_CLICK_EXIT)

game_over = sg.Window('Game Over', Layouts.layout_game_over(), font = 'Courier20')
